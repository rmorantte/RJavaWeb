...
public interface IRJavaSTARDesignManager {
	 ...
	 * @param fieldBookName - name of text file and the csv file 
	 ...
	 * @param rep - integer representing the number of replicates
	 * @param trial - integer representing the number of trials
	 * @param rowPerBlk - an integer representing the number of rows per block
	 * @param rowPerRep - an integer representing the number of rows per replicate
	 * @param numbFieldRow - an integer representing the number of rows in the field layout or number of rows in the design
	 * @param fieldOrder - a string indicating the field book order; possible values: "Plot Order" or "Serpentine"
	 */
	...
	/**
	 * calls the R statements for designRowColumn
	 * 
	 * @param path - path output will be save
	 * @param fieldBookName - name of text file and the csv file 
	 * @param numTrmt - an integer representing levels of the factor/treatment
	 * @param rep - integer representing the number of replicates
	 * @param trial - integer representing the number of trials
	 * @param rowPerRep - an integer representing the number of rows per replicate
	 * @param numbFieldRow - an integer representing the number of rows in the field layout or number of rows in the design
