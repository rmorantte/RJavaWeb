...
//		boolean saveMem = true;
		...
		rJavaManager.getSTARAnalysisManager().doClusterAgglo(dataFileName, outputPath,
				var, idVar,sbinVar, abinVar, ofactorVar, factorVar, stand, distance, clusmethod, distMatrix, copDistance,clusterMem, descriptiveStatRaw, corMatx, scatterMatx, descriptiveStat, 
