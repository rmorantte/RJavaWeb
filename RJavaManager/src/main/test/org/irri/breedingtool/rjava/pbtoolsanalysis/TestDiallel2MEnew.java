...
public class TestDiallel2MEnew {
...
//		String dataFileName = DATA_PATH + "Diallel2Alpha_missing.csv";
		...
		String outFileName = DATA_PATH + "Diallel2_ME_output.txt";
...
//		String alpha = "0.80";
		...
		//specify parameters
//		String dataFileName = DATA_PATH + "Diallel2RowCol.csv";
//		
...
//		String alpha = "0.80";
		...
		rJavaManager.getPbToolAnalysisManager().doDiallel2METest(dataFileName, outFileName, resultFolderPath, design, respvar, p1, p2, rep, block, row, column, cross, individual, environment, alpha);
	}
