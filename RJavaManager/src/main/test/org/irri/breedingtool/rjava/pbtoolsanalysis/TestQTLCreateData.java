...
public class TestQTLCreateData {
...
//				minDist, stepSize, addModel, numCofac, mlAlgo, setupModel, includeEpistasis, useDepPrior, priorMain, priorAll, maxQTLs, priorProb);
		...
		rJavaManager.getWebToolManager().doCreateQTLData(resultFolderPath, dataFormat, format1, crossType, file1, 
				format2, file2, format3, file3, P_geno, bcNum, fNum);

		System.out.println("TestQTLCreateData here");
