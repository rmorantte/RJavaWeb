...
public class TestDesignSplit2RCBD {
	...
	public static void main(String[] args) {
		...
		String fieldBookName = "fieldbookSplit2RCBD";
		String main = "Fertilizer";
		String sub = "Nitrogen";
		String ssub = "Variety";
		String sssub = null;
		String[] factorID = {"F", "N", "V"}; // factor ID for main plot and sub plot factor respectively
		Integer[] factorLevel = {5, 4, 4}; // factor level for main plot and sub plot factor respectively
		Integer rep = 6;
		Integer rowPerBlk = 5; 			
		Integer rowPerMain = 2;
		Integer rowPerSub = 2; 			
		Integer rowPerSubSub = 1; 		// for Split2 Plot Design, rowPerSubSub is equal to 1
