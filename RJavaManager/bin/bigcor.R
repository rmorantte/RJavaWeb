###########
#  bigcor
#  Lifted from http://www.dr-spiess.de/scripts/bigcor.R
#' Function for creating matrix of correlation coefficients for large datasets
#
#  Parameters:

#' @param x data 
#' @param fun function to perform, whether "cor" or "cov"
#' @param size number of blocks
#' @param verbose logical 
#' @param to.ffdf logical, whether output is to be converted to ffdf matrix or not

#  Output
#   resMat matrix of correlation coefficients
###########
