...
//		String dataFileName = DATA_PATH + "NC2Alpha_missing.csv";
		...
		String outFileName = DATA_PATH + "NCII_output.txt";
...
//		String individual = "NULL";
		...
		rJavaManager.getPbToolAnalysisManager().doNC2Test(dataFileName, outFileName, design, respvars, female, male, rep, block, row, column, inbred, individual, environment);
	}
