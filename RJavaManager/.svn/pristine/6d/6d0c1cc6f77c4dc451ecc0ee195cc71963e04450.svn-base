...
public class TestPairedMedian {
	...
	public static void main(String[] args) {
		...
		//specify parameters
		String[] varX = {"DFF", "PLHT"};
		String[] varY = {"PNCLE", "GRNYLD"};
		...
		rJavaManager.getSTARAnalysisManager().doPairedMedian(dataFileName, outFileName, varX, varY, altHypo, confInt, confLevel);
	}
