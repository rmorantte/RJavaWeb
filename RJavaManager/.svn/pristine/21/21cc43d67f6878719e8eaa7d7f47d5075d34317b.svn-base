...
public class TestDiallel3MEnew {
...
//		String dataFileName = DATA_PATH + "Diallel3Alpha_missing.csv";
		...
		String outFileName = DATA_PATH + "Diallel3_ME_output.txt";
...
//		String alpha = "0.05";
		...
		rJavaManager.getPbToolAnalysisManager().doDiallel3METest(dataFileName, outFileName, resultFolderPath, design, respvar, p1, p2, rep, block, row, column, cross, individual, environment, alpha);
	}
