...
public class TestNCIIInew {
	...
	public static void main(String[] args) {
		...
		String outFileName = DATA_PATH + "NCIII_output.txt";
...
//		String environment = "NULL";
		...
		rJavaManager.getPbToolAnalysisManager().doNC3Test(dataFileName, outFileName, design, respvars, tester, f2lines, rep, block, row, column, inbred, individual, environment);
	}
