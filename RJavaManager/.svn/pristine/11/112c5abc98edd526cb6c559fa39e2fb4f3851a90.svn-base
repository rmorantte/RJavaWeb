...
public class TestPlsRegression {
	...
	public static void main(String[] args) {
		...
		String outFileName = DATA_PATH + "PlsRegression_output.txt";
		String resultFolderPath = DATA_PATH;

		//Covariate: environment characteristics
//		String dataFileName= DATA_PATH + "means_for_PLS2.csv";
//		String[] respvar= {"YLD"};
//		String environment = "ENV";
//		String genotype = "GENOTYPE";
//		String covariateData = DATA_PATH + "ENVIRONMENTAL DATA FOR PLS2.csv";
...
//		String covariateGenotype="NULL";
		...
		rJavaManager.getPbToolAnalysisManager().doPlsRegression(dataFileName, outFileName, resultFolderPath, respvar, environment, genotype, covariateData, covariateEnvironment, covariateGenotype);
	}
