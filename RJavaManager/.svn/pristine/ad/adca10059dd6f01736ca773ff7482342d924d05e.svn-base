...
public class TestDesignStripSplit {
	...
	public static void main(String[] args) {
		...
		String fieldBookName = "fieldbookStripSplit";
		String vertical = "Variety";
		String horizontal = "Nitrogen";
		String sub = "Fertilizer";
		String ssub = null;
		String[] factorID = {"V", "N", "F"}; // factor ID for vertical, horizontal and sub plot factor respectively
		Integer[] factorLevel = {5, 4, 4}; // factor level for vertical, horizontal and sub plot factor respectively
		Integer rep = 6;
